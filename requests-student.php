...
<li class="nav-item dropdown" id="requests-student">
  ...
  <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
    ...
    if (isset($numOfRequests)){
        ...
        $sql = "SELECT * , studentImage from student_group JOIN student_group_request ON student_group.groupId = student_group_request.groupId JOIN student ON student.studentId = student_group_request.studentId  WHERE student_group_request.groupId = '$groupId' ";
        $result = $link->query($sql);
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
