    ...
    if (isset($_POST['btnGradeStudents'])){
        ...
        if (isset($_POST['contribution']) && isset($_POST['answerToquestion']) && isset($_POST['completion'])){
            ...
            for ($x = 0; $x < $count; $x++) {
                ...
                $sql = "INSERT INTO grades (studentId, groupId, fypPart, comments,contribution,anstoques,completion, grade,gradedBy) VALUES ('$studentId[$x]', '$groupId', '$fypPart' , '$comments[$x]','$Contribution[$x]','$answerToquestion[$x]','$completion[$x]', '$grade[$x]','$facultyId')";
                                    ...
                                    <div class="col-sm-10">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu " aria-labelledby="dropdownMenu1">
                                                ...
                                                <?php
                                                $sql = "SELECT * FROM faculty_student_group JOIN student_group ON faculty_student_group.groupId = student_group.groupId WHERE fypPart = 1";
                                                $result = $link->query($sql);
