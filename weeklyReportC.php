                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php if($row['score']== 1){echo "Very Poor";} elseif($row['score']== 2){echo "Poor";} elseif($row['score']== 3){echo "Average";} elseif($row['score']== 4){echo "Good";} elseif($row['score']== 5){echo "Very Good";}?></td>
