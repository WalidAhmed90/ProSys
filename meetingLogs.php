                ...
                <?php if (isset($_GET['add'])){
                    ...
                    <div class="card no-border">
                        <div class="card-header">
                            <h3 class="card-title">Add New Meeting Log</h3>
...
<!--                                <a href="--><?php //echo $_SERVER['PHP_SELF'];?><!--" class="btn btn-default ">Cancel</a>-->
                                <button type="submit" name="addNewLogBtn" class="btn btn-primary float-right" onclick="return confirm('Are you sure?')">Submit</button>
                            </div>
                        </form>
                ...
                <?php if (isset($_GET['edit']) && is_numeric($_GET['edit']) && strlen($_GET['edit']) > 0 ){
                    ...
                    <div class="card no-border">
                        <div class="card-header">
                            <h3 class="card-title">Edit Meeting Log: <?php echo $meetingTitle?></h3>
                        </div>
...
<!--                                    <a href="--><?php //echo $_SERVER['PHP_SELF'];?><!--" class="btn btn-default">Back</a>-->
                                    <button type="submit" form="editLogs" name="btnEditLog"  class="btn btn-primary float-right">Submit</button>
                                </div>
