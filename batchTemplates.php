...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (isset($_GET['delete'])){
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $batchName = mysqli_query($link,"SELECT batchName FROM batch WHERE batchId = '$batchId' ");
              mysqli_fetch_object( $batchName);
                        ...
                        <div class="card no-border">
                            ...
                            <div class="card-body  no-padding">
                                ...
                                <div class="card-footer">
                                    <a href="<?php echo $_SERVER['PHP_SELF'];?>" class="btn btn-default btn-sm float-left">Back</a>
                                    <button type="submit" name="btnUploadTemplate" id="btnUploadTemplate" form="uploadTemplates" class="btn btn-primary btn-sm float-right"><i class="fa fa-upload" ></i>Upload</button>
                                </div>
                            ...
                            <?php if (isset($_GET['batchId']) && is_numeric($_GET['batchId']) && strlen($_GET['batchId']) >0 ){ ?>
                                <div class="card-body  no-padding">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="<?php echo $_SERVER['PHP_SELF'] . '?add='.$batchId; ?>" class="btn  btn-primary btn-sm float-right "><i class="fa fa-upload" ></i> Add New Template</a>
                                    </div>
                                </div>
                                <!-- /.card-body -->
