...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (isset($_GET["group"]) and is_numeric($_GET["group"]) ){
        ...
        $sql = "SELECT id FROM grades WHERE groupId='$groupId' AND fypPart=1 AND gradedBy = '$facultyId'  LIMIT 1 ";
        $result = $link->query($sql);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['btnGradeStudents'])){
        //VALIDATIONS
     if (isset($_POST['contribution']) && isset($_POST['answerToquestion']) && isset($_POST['completion'])){
        ...
        for ($x = 0; $x < $count; $x++) {
            ...
            $grade[$x] = $Contribution[$x] + $answerToquestion[$x] + $completion[$x];
            $sql = "INSERT INTO grades (studentId, groupId, fypPart, comments,contribution,anstoques,completion, grade,gradedBy,iscord) VALUES ('$studentId[$x]', '$groupId', '$fypPart' , '$comments[$x]','$Contribution[$x]','$answerToquestion[$x]','$completion[$x]', '$grade[$x]','$facultyId','$iscord')";
    ...
    else if ($_POST['contribution[]'] == "" && $_POST['answerToquestion[]'] == ""  && $_POST['completion[]'] == "" ){
            //GRADE NOT SELECTED
    ...
    if (isset($_POST['btnEditGrade'])){
     ...
     $answerToquestion = filter_input(INPUT_POST,'answerToquestion',FILTER_SANITIZE_NUMBER_INT);
     ...
     $grade = $contribution + $answerToquestion + $completion;


     $sql = "UPDATE grades SET contribution='$contribution', anstoques='$answerToquestion', completion ='$completion', comments ='$comments',grade='$grade' WHERE id='$gradeId' ";
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                if (isset($_GET['edit']) && is_numeric($_GET['edit']) && strlen($_GET['edit'])>0 ){
                    ...
                    $sql = "SELECT * FROM grades JOIN student ON student.studentId = grades.studentId WHERE grades.id = $gradeId AND fypPart = 1 LIMIT 1";
                    $result = $link->query($sql);
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            $answerToquestion = $row['anstoques'];
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="answerToquestion" class="mr-3">Answer To Question: </label>
                                                <input type="number" name="answerToquestion"  min="0" max="10" required value="<?php echo $answerToquestion;?>" >
                                            </div>
                                            <div class="form-group">
                                                <label for="completion" class="mr-3">Completion: </label>
                                                <input type="number" name="completion"  min="0" max="20" required value="<?php echo $completion;?>">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu " aria-labelledby="dropdownMenu1">
                                                ...
                                                <?php
                                                $sql = "SELECT * FROM faculty_student_group JOIN student_group ON faculty_student_group.groupId = student_group.groupId WHERE NOT facultyId= '$facultyId' AND fypPart = 1";
                                                $result = $link->query($sql);
                            ...
                            <div class="card card-primary card-outline">
                             ...
                             <div class="card-body table-responsive">
                                ...
                                <table class="table table-condensed">
                                    ...
                                    <?php 
                                    $sql = "SELECT facultyName, studentRid , studentName ,  `contribution`,`anstoques`,`completion`,`comments`,`grade`  FROM `faculty` JOIN grades ON faculty.facultyId = grades.gradedBy JOIN student ON grades.studentId = student.studentId WHERE grades.groupId = '$groupId' AND fypPart = 1 order by studentName";
                                    $result = $link->query($sql);
                        ...
                        <div class="card card-primary card-outline">
                           ...
                           <div class="card-body table-responsive">
                            ...
                            <table class="table table-condensed">
                                ...
                                <?php
                                $sql = "SELECT `studentRid`, `studentName`, AVG(`contribution`) as contribution , AVG(`anstoques`) as AnswerToQuestion , AVG(`completion`) as Completion , AVG(`grade`) as grade  FROM grades JOIN student ON grades.studentId = student.studentId WHERE grades.`groupId`= '$groupId' AND fypPart = 1 GROUP BY grades.`studentId`";
                                $result = $link->query($sql);
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo number_format($row['AnswerToQuestion'],1); ?></td>
                                            <td><?php echo number_format($row['Completion'],1);?></td>
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while($row = $result->fetch_assoc()) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="answerToquestion[]" min="0" max="10" required></td>
                                                <td><input type="number" name="completion[]" min="0" max="20" required>
                                                </td>
         ...
         <div class="card card-primary card-outline">
            ...
            <div class="card-body table-responsive">
                <table class="table table-condensed">
                    ...
                    <?php
                    $sql = "SELECT * FROM grades JOIN student ON student.studentId = grades.studentId WHERE grades.groupId = '$groupId' AND fypPart = 1 AND gradedBy = '$facultyId' ";
                    $result = $link->query($sql);
