                            ...
                            <?php } ?>
                                ...
                                <div class="form-group">
                                    <label>Proposed Work</label>
                                     <textarea class="textarea" name="proposedWork" placeholder="Enter Proposed Work...." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"
                                     required></textarea>
                                </div>
                      ...
                      <option value="5">Very Good</option>
                                ...
                                <div class="form-group">
                                        <label>Achievements</label>
                                         <textarea class="textarea" name="Achievements" placeholder="Enter Achievements...." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"
                                     required></textarea>
                ...
                <?php if (isset($_GET['edit']) && is_numeric($_GET['edit']) && strlen($_GET['edit']) > 0 ){
                        ...
                        <div class="card-body">
                            ...
                            <form id="editWeekly" name="editWeekly" action="" method="post" data-toggle="validator">
                                ...
                                <div class="card-body">
                                   ...
                                   <div class="form-group">
                                    <label>Planned Work</label>
                                     <textarea class="textarea"  name="plannedWork" placeholder="Enter Planned Work...." 
                                     style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required><?php echo $planned_work; ?></textarea>
                                </div>

                                <div class="form-group">
                                    <label>Proposed Work</label>
                                     <textarea class="textarea" name="proposedWork" placeholder="Enter Proposed Work...."  
                    ...
                    <select class="form-control" id="score" name="score" required>
                      ...
                      <option value="5" <?php if($score== 5){echo "selected";}?>>Very Good</option>
                                ...
                                <div class="form-group">
                                        <label>Achievements</label>
                                         <textarea class="textarea" name="Achievements" placeholder="Enter Achievements...." 
                                           style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"
                                    ...
                                    <div class="form-group">
                                        <label>Add Comments</label>
                                        <textarea class="textarea" name="addComments"  placeholder="Add Comments..." 
                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $comments; ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Student Attendance</label>
