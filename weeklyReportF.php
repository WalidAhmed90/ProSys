                                        ...
                                        <div class="card-body">
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="textarea" name="plannedWork" placeholder="Enter Planned Work...." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required><?php echo $proposed_work; ?></textarea>
                                                </div>
                                                <?php
                                            } else{ ?>
                                                ...
                                                <div class="form-group">
                                                    <label>Planned Work</label>
                                                    <textarea class="textarea" name="plannedWork" placeholder="Enter Planned Work...." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required></textarea>
                                                </div>
                                                <?php
                                            }?>
                                            <div class="form-group">
                                                <label>Proposed Work</label>
                                                <textarea class="textarea" name="proposedWork" placeholder="Enter Proposed Work...." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"required></textarea>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="textarea" name="Achievements" placeholder="Enter Achievements...." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"required></textarea>
                                            </div>

                                            <div class="form-group">
                                                <label>Add Comments</label>
                                                <textarea class="textarea" name="addComments"  placeholder="Add Comments..."  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                                </textarea>
                                            </div>

                                            <div class="form-group">
                                                <label>Student Attendance</label>
                                                <textarea class="textarea" name="Attendance"  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="editWeekly" name="editWeekly" action="" method="post" data-toggle="validator">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        <label>Planned Work</label>
                                                        <textarea class="textarea"  name="plannedWork" placeholder="Enter Planned Work...."style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required><?php echo $planned_work; ?></textarea>
                                                    </div>

                                                    <div class="form-group">
                                                        <label>Proposed Work</label>
                                                        <textarea class="textarea" name="proposedWork" placeholder="Enter Proposed Work...."style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required><?php echo $proposed_work; ?></textarea>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label>Achievements</label>
                                                        <textarea class="textarea" name="Achievements" placeholder="Enter Achievements...." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required><?php echo $achievements; ?></textarea>
                                                    </div>

                                                    <div class="form-group">
                                                        <label>Add Comments</label>
                                                        <textarea class="textarea" name="addComments"  placeholder="Add Comments..." style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $comments; ?></textarea>
                                                    </div>

                                                    <div class="form-group">
                                                        <label>Student Attendance</label>
                                                        <textarea class="textarea" name="Attendance"  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $attendance; ?></textarea>
                                                    </div>
                                                </div>
                                                <!-- /.card-body -->
                                            </form>
                                            ...
                                            <div class="card-footer">
                                                ...
                                                <?php //echo $_SERVER['PHP_SELF'];?><!--" class="btn btn-default">Back</a>-->
                                            ...
                                            <form id="selectGroup"  method="get" name="selectGroup" data-toggle="validator">
                                                ...
                                                <div class="input-group input-group-sm" style="width: 250px;">
                                                    <select name="id" class="form-control" required>
                                                        ...
                                                        if ($result->num_rows > 0) {
                                                            while($row = $result->fetch_assoc()) { ?>
                                                                <option value="<?php echo $row['groupId']; ?>"><?php if (isset($row['projectName'])){echo 'Group:'.$row['groupId']. '[ '.$row['projectName'].' ] ';}else{ echo '--';}?></option>
                                                                <?php
                                                            }
                                                        }?>
                                                    </select>
