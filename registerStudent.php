        ...
        */
        ...
        if (($_POST['name']) !="" && $_POST['rid'] !="" && $_POST['batchId'] !="" ){
            ...
            if ($result->num_rows > 0) {
                ...
                $stmt->bind_param("sssii", $name, $rid,$secure_pass,$batchId, $isActive);
                        ...
                        <?php if (isset($_GET['batchId']) && is_numeric($_GET['batchId']) && strlen($_GET['batchId'])){
                            ...
                            <form id="registerStudent" name="registerStudent" action="" method="post" data-toggle="validator">
                                ...
                                <div class="form-group col-md-4 float-left">
                                    <input type="number" name="rid" class="form-control" min="00000" max="99999" placeholder="Enter Registration ID" required/>
                                    
                                </div>

                                <div class="form-group col-md-4 float-left">
                                    <input type="text" name="name" pattern="[a-zA-Z][a-zA-Z ]{4,}"  class="form-control" placeholder="Enter Full name" maxlength="20" minlength="5" required/>
                                </div>
