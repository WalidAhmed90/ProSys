           ...
           //If request accepted delete request from record
                ...
                if ($link->query($sql) === TRUE) {
                    ...
                    if ($link->query($sql) === TRUE) {
                         ...
                         * Walid ahmed is now supervising group (FYP Management System)
                        ...
                        //Get Batch id,projectName and Fyp part from groupId
                                        ...
                                        while($row = $result->fetch_assoc()) { ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    <td>
                                                        <?php if ((strtotime($row['taskDeadline']) - strtotime($row['uploadedDtm'])) > 0){
                                                        echo "<span class=\"badge bg-success\">IN TIME</span>";
                                                    } else {
